...
📁 Created backups directory: /path/to/project/backups
...
📂 Backup saved to: /path/to/project/backups/backup-2023-01-01T12-00-00.sql
```
...
📂 Using most recent backup: /path/to/project/backups/backup-2023-01-01T12-00-00.sql
...
⏳ Proceeding with restore in 5 seconds... (Press Ctrl+C to cancel)
...
This will output:
```
✅ Backup and restore modules imported successfully

...
export const FEATURES = [
  {
    ...
    description: 'Generate engaging social media content with our advanced AI algorithms.',
    icon: '🤖'
  },
  {
    title: 'Multi-Platform Publishing',
    description: 'Publish to all major social media platforms with a single click.',
    icon: '📱'
  },
  {

...
export function ComponentName({}: ComponentNameProps) {
  return <div className={cn('base-classes')}>{/* Component content */}</div>;
}
```
...
StackForge includes a Component Playground that showcases all available UI components with interactive examples. You can explore the [Component Playground](/development/component-playground) to see how components work and how to implement them in your application.

## UI Component Library

For a comprehensive guide to all UI components available in StackForge, see the [UI Components](/development/ui-components) documentation.
...
>
  Explore the interactive component showcase
</Card>
